...
export const HEROES: Hero[] = [
  ...
  },
  {
    id: 'tala',
    name: 'Tala',
    title: 'Goddess of the Morning Star',
    baybayin: 'ᜆᜎ',
    quote: 'Look to the morning star; it guides the lost through the darkest night.',
    passive: {
      id: 'tala-passive',
      name: 'Starfall Prism',
      blurb: 'Consecutive attacks mark targets with Starlight; 3 stacks trigger an Astral Burst for +110 magic damage and true sight.',
      emoji: '⭐',
      effect: '3-Stack Starlight Burst (+110 Dmg & True Sight)',
    },
    model: {
      rigged: '/models/heroes/argent-rigged.glb',
      walk: '/models/heroes/argent-walk.glb',
    },
    origin: 'The celestial goddess who heralds the dawn with the morning star',
    lore:
      'Daughter of the Maker and sister of Mayari and Apolaki. Tala creates the constellation paths that guide sea voyagers and illuminate the celestial night with brilliant starlight.',
    role: 'ranger',
    emoji: '⭐',
    portrait: '/models/heroes/argent.png',
    palette: { skin: '#f5d0a9', cloth: '#1e3a8a', accent: '#facc15', hair: '#0f172a' },
    build: { scale: 1.05, bulk: 0.94, gear: ['crossbow', 'cape'] },
    health: 790,
    speed: 6.8,
    attack: 72,
    attackRange: 8.8,
    ...
    abilities: [
      {
        ...
        blurb: 'Fires a high-velocity prism arrow that pierces through foes in a beam of starlight.',
        emoji: '🏹',
        shape: 'projectile',
        cooldown: 6.5,
        range: 13.0,
      ...
      {
        id: 'tala-trap',
        name: 'Constellation Trap',
        blurb: 'Summons a glowing stellar constellation on target ground that detonates and roots intruders.',
        emoji: '✨',
        shape: 'ground',
        cooldown: 9.0,
        range: 9.0,
      ...
      },
      {
        id: 'tala-vault',
        name: 'Astral Vault',
        blurb: 'Dashes swiftly backward or sideways while releasing a trail of blinding stellar sparks.',
        emoji: '💫',
        shape: 'dash',
        cooldown: 8.0,
        range: 8.0,
    ...
    ultimate: {
      ...
      blurb: 'Calls down a concentrated starlight barrage across a massive area that incinerates enemy formations.',
      emoji: '🌟',
      shape: 'cone',
      cooldown: 75,
      range: 12.0,
